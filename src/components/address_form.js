...
import "../App.css";
const { REACT_APP_GEOCLIENT_APP_ID, REACT_APP_GEOCLIENT_APP_KEY } = process.env;

var geoclient_url = `https://api.cityofnewyork.us/geoclient/v1/search.json?app_id=${REACT_APP_GEOCLIENT_APP_ID}&app_key=${REACT_APP_GEOCLIENT_APP_KEY}&input=`;
